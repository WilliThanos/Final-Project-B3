...
const FlashMessage = () => {
  ...
  return (
    ...
    // </div>
    <div
    className={flashMessage.type === 'success' ? 'flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-white dark:text-green-400 dark:border-green-800' : 'flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-gray-800 dark:bg-white dark:text-red-400 dark:border-red-800'}
     role='alert'
    >
        <svg
