...
export default function Filter() {
  ...
  return (
    <div className="w-64 mx-auto bg-white rounded-xl shadow-sm p-4 max-md:text-center max-md:border max-md:text-sm max-md:border-gray-300 max-md:p-2 max-md:w-44 max-md:mx-0">
