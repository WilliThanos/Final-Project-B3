...
export default function DetailPenumpangDewasa({
  passenger,
  index,
  handleInputChange,
  handleDateChange,
  ...
  const validateAge = () => {
    ...
    if (passengerAge >= 12 && passengerAge <= 100) {
  ...
  return (
    <div className="mx-auto w-full bg-white rounded-xl shadow-sm px-6 max-sm:px-4 my-4">
      <div className="w-full pt-10 max-lg:w-full">
        <div className="font-semibold text-lg max-md:text-base">
          Informasi Penumpang {index + 1}{" "}
          <span className="ml-2 text-sm text-gray-500">(Dewasa)</span>
        </div>
