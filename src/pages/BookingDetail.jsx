          ...
          <div className="">
            ...
            <div className="flex flex-col">
              ...
              <button
                ...
                className={`rounded-xl bg-[#2A91E5] px-5 mt-4 max-sm:my-2 py-2.5 w-48 self-center max-lg:w-full font-medium text-white hover:bg-sky-700 hover:text-gray-200 hover:shadow `}
              >
